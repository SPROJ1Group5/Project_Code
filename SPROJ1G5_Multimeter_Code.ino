...
//Defined Constants
const byte total_modes = 7 , LCD_ADDR = 0x27 , LCD_ROWS = 20 , LCD_COLS = 4 , resistanceRanges = 5 ;
...
const float resistanceFactors [ 5 ] = { 100.0 , 1000.0 , 10000.0 , 100000.0 , 1000000.0 } ;
...
const byte prevButtonPin = 2 , nextButtonPin = 3 , buzzerPin = 4 , freqPin = 5 , relay2Pin = 7 , resistanceSelectPins [ 5 ] = { 8 , 9 , 10 , 11 , 12 } ;
...
void selectRelayCombination ( byte selector ) {
  ...
  switch ( selector ) {
    ...
    /*RESISTANCE*/ case 2 : digitalWrite ( relay2Pin , LOW )  ; digitalWrite ( relay1Pin , HIGH ) ; break ; } /* end switch */ }  //end selectRelayCombination
...
void nextButtonPressed ( void ) {
  next = true ; } //end nextButtonPressed

void prevButtonPressed ( void ) {
  prev = true ; } //end prevButtonPressed
...
void temperatureTest ( void ) {
  ...
  LCD.setCursor ( 0 , 1 ) ;
  LCD.print ( "      " + String ( tempVal ) + " °C     " ) ; } //end temperatureTest
...
void loop ( ) {
  ...
  switch ( mode_select ) {
    case 1 : LCD.setCursor ( 0 , 0 ) ; LCD.print ( "      Voltmeter     " ) ; selectRelayCombination ( 0 ) ; voltageTest ( ) ; break ;
    case 2 : LCD.setCursor ( 0 , 0 ) ; LCD.print ( "     Ampermeter     " ) ; currentTest ( ) ; break ;
    case 3 : LCD.setCursor ( 0 , 0 ) ; LCD.print ( "     Ohm-meter      " ) ; selectRelayCombination ( 2 ) ; resistanceTest ( ) ; break ;
    case 4 : LCD.setCursor ( 0 , 0 ) ; LCD.print ( "   Frequency-meter  " ) ; selectRelayCombination ( 1 ) ; frequencyTest ( ) ; break ;
    case 5 : LCD.setCursor ( 0 , 0 ) ; LCD.print ( "  Continuity test   " ) ; selectRelayCombination ( 2 ) ;  continuityTest  ( ) ; break ;
    case 6 : LCD.setCursor ( 0 , 0 ) ; LCD.print ( "  Temperature test  " ) ; temperatureTest ( ) ; break ;
    case 7 : LCD.setCursor ( 0 , 0 ) ; LCD.print ( "   Battery  Level   " ) ; LCD.setCursor ( 0 , 1 ) ; LCD.print ( "      Indicator     " ) ; batteryTest ( ) ; break ; 
